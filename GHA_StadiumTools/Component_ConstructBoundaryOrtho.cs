...
namespace GHA_StadiumTools
{
    ...
    public class ST_ConstructBoundaryOrtho : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Offset X", "oX", "The X-offset of the bowl edges from the playSurface", GH_ParamAccess.item, 10 * unit);
            pManager.AddNumberParameter("Offset Y", "oY", "The Y-offset of the bowl edges from the playSurface", GH_ParamAccess.item, 8 * unit);
        ...
        private static int OUT_Polyline = 5;
        ...
        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            ...
            pManager.AddCurveParameter("Polyline", "Pl", "Boundary Polyline", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Rhino.Geometry.PolylineCurve polyline = StadiumTools.IO.PolylineCurveFromPline(newBoundary.Polyline);
            ...
            DA.SetData(OUT_Polyline, polyline);
        }
