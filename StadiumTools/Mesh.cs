...
namespace StadiumTools
{
    public struct Mesh
    {
        ...
        public static Mesh Construct4x(Pt3d[] pts0, Pt3d[] pts1, Pt3d[] pts2, Pt3d[] pts3)
        {
            ...
            {
                throw new ArgumentException($"Error: Mesh.Construct4x Inputs must be equal length [{pts0.Length},{pts1.Length},{pts2.Length},{pts3.Length}]");
            }
        ...
        public static Mesh Construct2x(Pt3d[] pts0, Pt3d[] pts1)
        {
            ...
            {
                throw new ArgumentException($"Error: Mesh.Construct2x Inputs must be equal length [{pts0.Length},{pts1.Length}]");
            }
            List<Pt3d> vertices = new List<Pt3d>();
            List<Face> faces = new List<Face>();
            List<Vec3d> faceNormals = new List<Vec3d>();
